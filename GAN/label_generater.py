...
###  Autel_X-Star_Premium_Drone_for_Element_3D  ####
        ...
        if model_name == 'Autel_X-Star_Premium_Drone_for_Element_3D':
            storagelist.append([root_path +'/'+ img_path,model_name+';'+str(4)+';'+'red'+';'
...
###  DJI_Mavic_Mini  ####
            ...
            storagelist.append([root_path +'/'+ img_path,model_name+';'+str(4)+';'+'grey'+';'
...
###  DJI_Phantom_4_pro_3D_model  ####
            ...
            storagelist.append([root_path +'/'+ img_path,model_name+';'+str(4)+';'+'white'+';'
...
###  3DR_Solo_Drone_for_Element_3D  ####
            ...
            storagelist.append([root_path +'/'+ img_path,model_name+';'+str(4)+';'+'black'+';'
...
###  DJI_Mavic_Pro_for_Element_3D  ####
            ...
            storagelist.append([root_path +'/'+ img_path,model_name+';'+str(4)+';'+'Navy'+';'
                                +'Front-hung'+';'+'none'+';'+'Wing embedded'+';'+'none'+';'+'Cuboid shape'+';'
...
###  Customized_Drone  ####
            ...
            storagelist.append([root_path +'/'+ img_path,model_name+';'+str(4)+';'+'Metallic'+';'
