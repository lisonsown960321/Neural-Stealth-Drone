...
class BaseConfig(object):
    ...
    def __init__(self):
        """
        Set the defaults. Dataset is just for example, please revise to you own dataset, or request to corresponding author.
        """

        self.img_dir = "design_drone_org_verification_images"
        self.lab_dir = "design_drone_org_verification_labels"

        self.img_dir_v = "design_drone_org_verification_images"
        self.lab_dir_v = "design_drone_org_verification_labels"
        ...
        self.scheduler_factory = lambda x: optim.lr_scheduler.ReduceLROnPlateau(x, factor=0.5, mode='min', patience=10,min_lr=0.0001)
        self.max_tv = 0
...
class ReproducePaperObj_obj(BaseConfig):
    """
    Reproduce the results from the paper: Generate a patch that minimises object score.
    """
...
patch_configs = {
    ...
    "paper_obj_obj": ReproducePaperObj_obj,
}
